...
const isNotActiveStyle =
  " flex items-center px-5 gap-3 text-gray-500 hover:text-black transition-all duration-200 ease-in-out captilize  ";
    ...
    <div className="flex flex-col justify-between bg-white h-full overflow-y-scroll min-w-210 h-scrollbar ">
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-5">
          ...
          {categories.slice(0, categories.length - 1).map((cate) => (
            <NavLink
